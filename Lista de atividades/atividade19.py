quantidade_frango = int(input("Digite quantos frangos você deseja marcar: "))

valor_total = quantidade_frango * 11
print("Você irá gastar R$",valor_total)

#A granja Frangotech possui um controle automatizado de cada frango da sua produção. No pé direito do 
#frango há um anel com um chip de identificação; no pé esquerdo são dois anéis para indicar o tipo de 
